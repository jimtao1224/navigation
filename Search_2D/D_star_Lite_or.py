...
from Search_2D import plotting_or, env_or
...
class DStar:
    def __init__(self, s_start, s_goal, heuristic_type):
        ...
        self.Env = env_or.Env()  # class Env
        self.Plot = plotting_or.Plotting(s_start, s_goal)
    ...
    #     # self.ax.plot(px, py, linewidth=2)  # 使用存儲的 axes 對象繪圖
    #     # self.ax.plot(self.xI[0], self.xI[1], "bs")  # 起點
    #     # self.ax.plot(self.xG[0], self.xG[1], "gs")  # 終點
